...
- Cap chart-rendered capital outliers at 2x the deterministic scenario maximum so high-equity P90 outcomes do not flatten the rest of the chart. Tooltips and risk cards keep showing true simulation values.
