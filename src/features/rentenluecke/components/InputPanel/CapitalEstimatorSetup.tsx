...
export function CapitalEstimatorSetup({ settings, readiness, needsAutomatic, onSettingsChange, onJumpToInsurance }: {
  ...
  <fieldset><legend>Anschaffungskosten und Ertragsschätzung</legend>
    ...
    <p><strong>Kapitalertragsteuer auf Entnahmen, Umschichtungsgewinne und Bankzinsen wird bei automatischer Kapitalbasis automatisch berechnet und aus dem Portfolio finanziert (Abgeltungsteuer 25 % zuzüglich 5,5 % Solidaritätszuschlag, ohne Kirchensteuer und Günstigerprüfung; Bankzinsen ohne Teilfreistellung in derselben Bemessung).</strong> Bei manueller Kapitalbasis gilt die pauschale Entnahme-Näherung. Ergebnisse bleiben Planungsnäherungen und keine vollständig nach Steuern verfügbare Kaufkraft.</p>
  </fieldset>
  </details>
}
